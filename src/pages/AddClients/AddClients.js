  ...
  const handleClick = async () => {
    try {
      const response = await fetch('http://localhost:5001/addClients', {
        ...
        body: JSON.stringify({'clients': {'firmName': firmName, 'clientName': clientName, 'mol': mol, 'eik': eik, 'dds': dds, 'address': address, 'city': city, 'country': country, 'email':email,'phone':phone, 'clientType': clientType}} ), // Send your data here
      });
  ...
  <div className={styles.AddClients}>
    ...
    <div class="add-input-holder">
      <div class="add-input-row">
        ...
        <select class="col-1" style={{marginLeft:"30px", height: "45px"}} id="type" name="type" value={clientType} onChange={(e) => setClientType(e.target.value)}>
    ...
    <div class="add-input-btns">
      <div class="add-input-add" onClick={handleClick}>
        <span>Запис</span>
      </div>
